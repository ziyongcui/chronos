...
//  chronos
//
//  Created by Paul Development on 8/8/20.
...
class FloatingLabelInput: UITextField {
    ...
    @IBInspectable
    var floatingLabelColor: UIColor = UIColor.systemBlue {
        didSet {
    ...
    required init?(coder aDecoder: NSCoder) {
        ...
        self.addTarget(self, action: #selector(self.addFloatingLabel), for: .allEditingEvents)
        self.addTarget(self, action: #selector(self.removeFloatingLabel), for: .touchUpOutside)
    }
