...
//  chronos
//
//  Created by Paul Muser on 7/14/20.
...
class SinglePickerDialog: UIView, UITableViewDelegate, UITableViewDataSource {
    
    typealias SinglePickerCallback = (_ values: [[String: String]]) -> Void
    ...
    private var callback:            SinglePickerCallback?
