...
/*
let math = Block(time: 12, completedTime: <#Int#>, duration: 4, completionDuration: <#Int#>, name: "math", rigid: false, priority: 2, status: "not attempted")
let reading = Block(time: 16, completedTime: <#Int#>, duration: 4, completionDuration: <#Int#>, name: "reading", rigid: false, priority: 2, status: "not attempted")
let swim = Block(time: 20, completedTime: <#Int#>, duration: 4, completionDuration: <#Int#>, name: "swim", rigid: false, priority: 2, status: "not attempted")
*/
...
func calcTime(currentTime: Int) {
    print(IdealSchedule.blocks) //  prints the original schedule for comparison
