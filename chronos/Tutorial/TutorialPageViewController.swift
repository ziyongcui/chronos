...
class TutorialPageViewController: UIPageViewController, UIPageViewControllerDataSource, UIPageViewControllerDelegate {
    weak var pageChangeDelegate: TutorialHostViewController?
    ...
    override func viewDidLoad() {
        ...
        let items = Bundle.main.decode([TutorialItem].self, from: "Tutorial.json")

        for item in items {
            let viewController = TutorialItemViewController.instantiate()
